...
PROMPT_TEMPLATES = {
    ...
    3. Не выдумывай факты, используй только предоставленные данные. Если нет информации в представленных контекстах WIKI то ты должна сказать, чтобы переформулировали вопрос поскольку в найденных данных нет ответа на вопрос
